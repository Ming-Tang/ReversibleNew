...
\begin{matrix}I_2 \\ P(p) \\ I_n \end{matrix} &
\begin{matrix}R_2 \\ S_{2n,2n} \end{matrix} &
\begin{matrix}I_1 \\ T^+_n \end{matrix} &
...
## Multi-conditional diverge

$$\begin{aligned}
T^\pm_1 &= T^\pm &:&\quad 2 \leftrightarrow 3 \\
T^\pm_{n+1} &= \begin{bmatrix} \begin{matrix}
I_1 \\ T^\pm \\ I_n
\end{matrix}
\ \begin{matrix}
I_2 \\ T^\pm_n
